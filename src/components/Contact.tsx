...
export default function Contact({ dict }: { dict: Dict }) {
  ...
  return (
    <section id="contact" className="band-alt py-20 sm:py-28">
      <div className="container-page">
        <Reveal className="tile overflow-hidden">
          <div className="grid gap-0 lg:grid-cols-12">
            ...
            <div className="p-8 sm:p-12 lg:col-span-5">
              ...
              <h2 className="font-display text-balance text-3xl font-bold leading-[1.1] text-fg sm:text-4xl">
                {dict.contact.title}
              </h2>
              <p className="mt-4 leading-relaxed text-fg-muted">{dict.contact.subtitle}</p>

              <dl className="mt-10 space-y-5 text-sm">
                <div className="flex items-start gap-3">
                  <span className="mt-0.5 flex h-8 w-8 items-center justify-center rounded-[3px] border border-line text-accent">
            ...
            <form
              ...
              className="space-y-4 border-t border-line bg-surface p-8 sm:p-12 lg:col-span-7 lg:border-l lg:border-t-0"
            >
...
function Field({
  ...
  const base =
    "block w-full rounded-[var(--radius-tile)] border border-line bg-surface px-4 py-3 text-sm text-fg placeholder:text-fg-faint focus:border-accent focus:outline-none";
  return (

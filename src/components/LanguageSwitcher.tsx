...
import { useEffect, useId, useRef, useState, type ComponentType, type CSSProperties, type ElementType, type ReactNode, type Ref } from "react";
...
interface Props {
   ...
   * Typed loosely on purpose: forwardRef components don't fit a precise
   * props type under @types/react 18, and the five sites mix 18 and 19. It
   * must accept an anchor's props (href, ref, onClick…) and render an <a>.
   */
  linkAs?: ElementType;

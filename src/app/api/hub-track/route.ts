...
/**
 * Collects the site's analytics and forwards it to the CORPSC hub, with the key
 * added here, on the server: it must never reach the browser. Everything it
 * does lives in the shared tracker (corpsc-hub/tracker); `after()` lets the
